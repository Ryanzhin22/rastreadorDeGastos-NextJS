...
const TagCreate = ({openNewTag, setOpenNewTag}) => {
  ...
  return (
    <div className="z-10 absolute bottom-0 w-[600px] h-[600px] flex-col bg-white backdrop-blur-lg border-t-2 dark:bg-neutral-900 dark:text-neutral-300" style={{display: openNewTag ? "flex" : "none"}} >
        <button className="px-6 py-1 bg-neutral-700 text-white text-3xl absolute left-0 rounded-lg m-4 dark:bg-white dark:text-black hover:bg-neutral-900" onClick={handleBack}>🠔</button>
        ...
        <div className="flex flex-col gap-6 justify-center items-center">
            ...
            <button className="px-8 py-4 bg-neutral-700 text-white text-lg rounded-md dark:bg-white dark:text-black hover:bg-neutral-900" onClick={handleClose}>Confirmar</button>
        </div>
    </div>
  )
};
